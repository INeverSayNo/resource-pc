...
export function renderLevelColor(level?: string) {
  return stationLevelColorMap.get(level || "Todo");
}

export function renderLevelText(level?: string) {
  return stationLevelTextMap.get(level || "Todo") || "";
}
