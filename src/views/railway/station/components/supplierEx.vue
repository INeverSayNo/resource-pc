<template>
  <DcGap class="bar with-input">
    ...
    <div class="fr">
      ...
      >
        <template #append>
          <el-button @click="handleSearch"><DLegacyIcon name="search" /></el-button>
        </template>
      </el-input>
      <el-popconfirm
        class="dc-popconfirm"
  ...
  >
    ...
    >
      <template #default="scoped">
        ...
        <br
          v-if="
            scoped.row.supplier?.isContract ||
            scoped.row.supplier?.isChinaRailway
          "
        />
        <el-tag
          v-if="scoped.row.supplier?.supplierNatureName"
          type="primary"
          size="small"
          plain
          class="ml-10"
        ...
        <el-tag
          v-if="scoped.row.supplier?.isContract"
          type="success"
          size="small"
          class="ml-10"
          plain
        ...
        <el-tag
          v-if="scoped.row.supplier?.isChinaRailway"
          type="danger"
          size="small"
          class="ml-10"
          plain
    ...
    >
      <template #default="scoped">
        ...
        <span
          ...
          v-html="
            createPrivatePhone(scoped.row.supplier?.contactPhone).outerHTML
          "
        ></span>
      </template>
    </el-table-column>
    ...
    <el-table-column
      ...
      width="120"
      align="center"
      prop="supplier.costPrice"
    >
      <template #default="scoped">
        <span v-show="scoped.row.supplier?.costPirce">
          {{ scoped.row.supplier?.costPirce }}/{{
            scoped.row.supplier?.costPirceUnit
          }}
        </span>
      </template>
    </el-table-column>
    ...
    <el-table-column label="贡献者" align="center" width="180" prop="validDate">
      <template #default="scoped">
        ...
        <span
          ...
          class="theme-color cu-pointer"
          v-html="
            createPrivatePhone(scoped.row.supplier?.contributorPhone).outerHTML
          "
        ></span>
      </template>
    </el-table-column>
