    ...
    <div class="station-details thin-line-scroll">
      <div
        ...
        :style="{
          color: stationLevelColorMap.get(
            data?.station.stationLevelMark || 'Todo'
          )
        }"
      >
        <svg-icon icon-class="railwayicon"></svg-icon>
        {{ data?.station.railwayStationName }}
        <span class="theme-danger fs-12">
          
        </span>
        <span class="theme-warning fs-12">
      ...
      <div class="station-base-tag">
        ...
        <el-tag
          ...
          :type="
            item?.isShow ? 'primary' : item?.isRight ? 'success' : 'info'
          "
        >
      ...
      <el-row>
        ...
        <el-col v-if="data?.station?.scopeOfBusiness.includes('货场')" :span="24" class="station-base-tag">
          <span class="label fs-12 station-base-tag-title">货场办理</span>
          <el-tag
            v-if="data.station?.businessLimit"
            plain
            class="mr-5"
            type="primary"
            size="small"
        ...
        <el-col v-if="data?.station?.scopeOfBusiness.includes('专用线')" :span="24" class="station-base-tag">
