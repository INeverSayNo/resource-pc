  ...
  <transition name="viewer-fade">
    ...
    >
      ...
      <span
        ...
        :style="`--imgpreview-zIndex:${zIndex}`"
        @click="hide"
      >
        <DAliIcon name="minus" color="white" width="26" height="26" />
      </span>
      <!-- ARROW -->
      <template v-if="!isSingle">
        <span
          ...
          @click="prev"
        >
          <DAliIcon name="left" color="white" width="26" height="26" />
        </span>
        <span
          ...
          @click="next"
        >
          <DAliIcon name="right"  color="white" width="26" height="26" />
        </span>
      </template>
      <!-- ACTIONS -->
      <div class="image-viewer__btn image-viewer__actions">
        <div class="image-viewer__actions__inner">
          <DAliIcon  color="white" width="20" height="20" name="unscale" @click="handleActions('zoomOut')" />
          <DAliIcon  color="white" width="20" height="20" name="scale" @click="handleActions('zoomIn')" />
          <DAliIcon  color="white" width="20" height="20" name="resume" @click="toggleMode" />
          <DAliIcon  color="white" width="20" height="20" name="unrotate" @click="handleActions('anticlocelise')" />
          <DAliIcon  color="white" width="20" height="20" name="rotate" @click="handleActions('clocelise')" />
          <DAliIcon name="close" color="white" width="20" height="20" @click="hide" />
        </div>
      </div>
      <!-- CANVAS -->
...
<style lang="less" scoped>
  ...
  .image-viewer__close {
    ...
    z-index: calc(var(--imgpreview-zIndex) + 1);
  }
