    ...
    >
      ...
      <template v-if="!isSingle">
        <span
          ...
          @click="prev"
        >
          <DLegacyIcon name="arrow-left" class=" iconfont"  />
        </span>
        <span
          ...
          @click="next"
        >
          <DLegacyIcon name="arrow-right" class=" iconfont"  />
        </span>
      </template>
      <!-- ACTIONS -->
      <div class="image-viewer__btn image-viewer__actions">
        <div class="image-viewer__actions__inner">
          ...
          />
          <DLegacyIcon name="circle-close" class=" iconfont" @click="hide"  />
        </div>
      </div>
      <!-- CANVAS -->
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const isLast = computed(
      (): boolean => index.value === props.imageList.length - 1
    );
